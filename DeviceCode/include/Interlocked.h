...
__inline UINT32 InterlockedOr( volatile LONG* Destination, UINT32 Flag )
{
    SmartPtr_IRQ irq;
...
//#else
//
//__inline UINT32 InterlockedSet( volatile LONG* Destination, UINT32 Flag )
//{
//    return 0;
//}
//
//
//__inline UINT32 InterlockedUnset( volatile LONG* Destination, UINT32 Flag )
//{
//    return 0;
//}
